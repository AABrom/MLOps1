...
└── output/ # Директория с результатами скоринга, топ-5 фичами и распределением скоров
```
...
3. **Категориальные переменные**:
   - Label Encoding с опцией обновления кодирования при появлении неизвестного признака
